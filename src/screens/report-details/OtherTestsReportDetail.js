/**
 * Screen component for Other Reports detail
 */
...
const OtherTestsReportDetail = ({reportsData}) => {
                      ...
                      <View style={styles.expandableItemChildContainer}>
                        <View style={styles.detailsContainer}>
                          <AppText style={styles.detailsValue}>
                            {renderForNoData(item?.procedureNoteContent) ||
                              t('noOtherTestReportFound')}
                          </AppText>
                        </View>
                      </View>
                    </ExpandableItem>
...
export default OtherTestsReportDetail;
